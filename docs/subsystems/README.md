...
| [desktop.md](desktop.md) | the Electron desktop shell: the `dsh:` protocol carrier, `desktopRuntime` frontend-dist resolution, the `app:desktop-surface` orientation section |
